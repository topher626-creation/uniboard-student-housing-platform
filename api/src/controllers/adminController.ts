...
export class AdminController {
  ...
  async disableProvider(req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async getPendingProviders(_req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async getPendingProperties(_req: Request, res: Response, next: NextFunction) {
    try {
  ...
  async getOpenReports(_req: Request, res: Response, next: NextFunction) {
    try {
